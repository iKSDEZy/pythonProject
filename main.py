...
# name = 'jack'
# x = f'Hello my name is {name.capitalize()}'
# print(x)
#
#
...
# example_string5 = example_string5.split()
# print(example_string5)
# cost = example_string5[3]
# print(cost)
# cost = cost.rstrip('$')
# print(cost)
# cost = float(cost)
